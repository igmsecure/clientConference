...
import AuthorEditPage from "./pages/AuthorEditPage.tsx";
import AuthorsTablePage from "./pages/AuthorsTablePage.tsx";
      ...
      <BrowserRouter>
        <div className="App">
          ...
          <Routes>
            ...
            <Route path="/authorsManage" element={<AuthorsTablePage />} />
